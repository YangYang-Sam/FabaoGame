...
function Bullet.new(x, y, angle, speed, damage, range,effects,tracking,curveFactor,attribute,showImage,bulletImage)
...
function Bullet:update(dt,target)
    --更新子弹位置
    self.x = self.x + self.dx * dt
    self.y = self.y + self.dy * dt

    --如果开启追踪功能，更新子弹方向
    if self.tracking and target then
